...
TEST_GRAPE_ROLE = 1257320493539917935
TEST_PATH_ROLE = 1257318927277756616
TEST_SPEC_ROLE = 1257318954951643198

# Testing color roles
TEST_COLOR_COUNCIL_ROLE = 1422739163286999152
TEST_COLOR_ALUMNI_ROLE = 1422738963998703668
TEST_COLOR_MOD_ROLE =  1422739232199540847
...
def path_role():
    return PROD_PATH_ROLE if _production else TEST_COLOR_PATH_ROLE

def spec_role():
    return PROD_SPEC_ROLE if _production else TEST_COLOR_SPEC_ROLE
